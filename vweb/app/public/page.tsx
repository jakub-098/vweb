...
export default function PublicPreviewPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center overflow-hidden bg-[radial-gradient(circle_at_top,_#4c1d95_0,_#02010a_25%,_#02010a_55%,_transparent_70%),radial-gradient(circle_at_bottom,_#4c1d95_0,_#02010a_35%,_#000_80%)] text-zinc-50">
      {/* NAVBAR */}
      <header
        className={`fixed top-0 z-20 flex w-full justify-center transition-colors duration-300 ${
          navScrolled
            ? "bg-black/80 border-b border-zinc-800/80 backdrop-blur-xl"
            : "bg-transparent"
        }`}
      >
        <div
          className={`flex w-full max-w-6xl items-center justify-between text-sm text-zinc-300 sm:w-4/5 lg:w-2/3 transition-all duration-300 ${
            navScrolled
              ? "px-4 py-2 sm:px-8 rounded-none shadow-none"
              : "mt-4 px-5 py-3 sm:px-8 rounded-full border border-zinc-700/70 bg-black/60 shadow-[0_10px_30px_rgba(0,0,0,0.45)] backdrop-blur-xl"
          }`}
        >
          <span className="text-sm font-semibold tracking-tight text-zinc-50">
            <span className="text-sky-400">vas</span>web.sk
          </span>
          <nav className="flex items-center gap-4 text-xs font-medium text-zinc-300 sm:text-sm">
            <button
              type="button"
              onClick={() => {
                document
      ...
      <div
        className="pointer-events-none absolute inset-x-0 top-0 z-0 h-screen bg-[url('/bg.webp')] bg-cover bg-center opacity-40"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-x-0 top-0 z-0 h-screen bg-gradient-to-t from-black via-black/40 to-transparent"
        aria-hidden
      />
      ...
      <section className="flex min-h-[90vh] w-full items-center justify-center px-4 pt-28 sm:px-8">
        <div className="relative w-full max-w-6xl sm:w-4/5 lg:w-2/3">
          <div className="relative overflow-hidden rounded-2xl border border-zinc-700/80 bg-zinc-950/70 px-7 py-12 shadow-[0_14px_40px_rgba(0,0,0,0.75)] backdrop-blur-xl sm:px-11 sm:py-14">
            ...
            <div className="relative flex flex-col items-center text-center text-zinc-50">
              <p className="mb-3 text-[0.7rem] font-semibold uppercase tracking-[0.35em] text-sky-400/90">
                Ukážka
              </p>
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <button
                  ...
                  className="rounded-full bg-sky-500 px-6 py-2.5 text-sm font-medium text-white shadow-[0_10px_30px_rgba(56,189,248,0.6)] transition hover:bg-sky-400"
                >
                ...
                <button
                  ...
                  className="rounded-full border border-zinc-700 bg-zinc-900/70 px-6 py-2.5 text-sm font-medium text-zinc-100 shadow-[0_4px_18px_rgba(0,0,0,0.65)] backdrop-blur-sm transition hover:bg-zinc-800 hover:text-zinc-50"
                >
                  Služby a spolupráca
                </button>
              </div>
      ...
      <section id="about" className="w-full max-w-6xl px-4 pt-16 sm:w-4/5 lg:w-2/3 sm:px-0">
        <div className="relative overflow-hidden rounded-2xl border border-zinc-700/80 bg-zinc-950/70 px-8 py-10 shadow-[0_18px_40px_rgba(0,0,0,0.75)] backdrop-blur-xl sm:px-12 sm:py-14">
          <div className="grid gap-10 md:grid-cols-2 md:items-center">
            <div>
              <p className="text-[0.7rem] font-semibold uppercase tracking-[0.3em] text-sky-400">
                O projekte
              </p>
      ...
      <section className="w-full max-w-6xl px-4 pt-16 sm:w-4/5 lg:w-2/3 sm:px-0 ">
        <div className="relative mx-auto w-full">
          ...
          <div className="relative">
            <div className="pointer-events-none absolute inset-0 -z-10 rounded-[2.25rem] border border-zinc-700/80 bg-zinc-950/70 shadow-[0_18px_40px_rgba(0,0,0,0.8)] backdrop-blur-xl" />
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {["Hero", "O nás", "Služby", "Kontakt"].map((title, i) => (
                <div
                  key={title}
                  className="group relative overflow-hidden rounded-2xl border border-zinc-700/80 bg-zinc-900/80 px-6 py-7 text-left text-sm text-zinc-300 shadow-[0_14px_32px_rgba(0,0,0,0.8)] backdrop-blur-xl transition duration-200 hover:-translate-y-1.5 hover:border-zinc-500 hover:bg-zinc-900"
                >
                  ...
                  <p className="text-[0.7rem] font-medium uppercase tracking-[0.3em] text-sky-400">
                    Blok {i + 1}
                  </p>
      ...
      <section id="services" className="w-full max-w-6xl px-4 pt-16 sm:w-4/5 lg:w-2/3 sm:px-0 ">
        <div className="relative overflow-hidden rounded-2xl border border-zinc-700/80 bg-zinc-950/70 shadow-[0_18px_40px_rgba(0,0,0,0.8)] backdrop-blur-xl">
      ...
      {/* GALLERY */}
      <section className="w-full max-w-6xl px-4 pt-16 sm:w-4/5 lg:w-2/3 sm:px-0 ">
        <div className="relative overflow-hidden rounded-2xl border border-zinc-700/80 bg-zinc-950/70 px-8 py-10 shadow-[0_18px_40px_rgba(0,0,0,0.8)] backdrop-blur-xl sm:px-12 sm:py-14">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
            {Array.from({ length: galleryCount }).map((_, i) => (
              <div
                key={i}
                className="relative aspect-square overflow-hidden rounded-2xl border border-zinc-700/80 bg-[url('/bg.webp')] bg-cover bg-center shadow-[0_14px_32px_rgba(0,0,0,0.85)]"
              />
            ))}
          </div>
          ...
          {!showAllGallery && (
            <div className="mt-8 flex justify-center">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-zinc-700 bg-zinc-900/80 px-7 py-2.5 text-sm font-medium text-zinc-100 shadow-[0_4px_18px_rgba(0,0,0,0.8)] backdrop-blur-sm transition hover:bg-zinc-800 hover:text-zinc-50 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(0,0,0,0.9)]"
              >
      ...
      >
        <div className="relative overflow-hidden rounded-2xl border border-zinc-700/80 bg-zinc-950/70 px-8 py-10 shadow-[0_18px_40px_rgba(0,0,0,0.85)] backdrop-blur-xl sm:px-12 sm:py-14">
          ...
          <form className="space-y-8">
            <div className="space-y-3">
              ...
              <input
                ...
                type="email"
                required
                className="w-full rounded-xl border border-zinc-700 bg-zinc-900/80 px-4 py-3 text-sm text-zinc-50 outline-none ring-0 transition placeholder:text-zinc-500 focus:border-zinc-400 focus:bg-zinc-900"
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                required
                rows={4}
                className="w-full resize-none rounded-xl border border-zinc-700 bg-zinc-900/80 px-4 py-3 text-sm text-zinc-50 outline-none ring-0 transition placeholder:text-zinc-500 focus:border-zinc-400 focus:bg-zinc-900"
